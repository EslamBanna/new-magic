...
<div class="container-fluid animatedParent animateOnce my-3">
    <div class="animated fadeInUpShort go">
       <div class="card">
       <div class="container">
       <form class="mt-5 mb-5" id="needs-validation" novalidate="" action="{{route('organizers.store')}}" method="post">
        @csrf
            ...
            <div class="row">
                <div class="col-md-8 ">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" name="name" placeholder="organizer Name" value="{{old('fullname')}}" required="">
                        ...
                        <div class="col-md-6  mb-3">
                            ...
                            <input type="email" class=" form-control" id="validationCustom02" name="email" placeholder="organizer Email" value="{{old('email')}}" required="">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" id="validationCustom03" name="password" placeholder="organizer password" value="{{old('password')}}" required="" minlength="8">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom05" name="phone" placeholder="organizer phone" value="{{old('phone')}}" >
                        ...
                        <div class="col-md-6 mb-3"id="category">
                            ...
                            <input type="text" class="form-control" id="validationCustom04" name="category" placeholder="category" value="{{old('category')}}">
