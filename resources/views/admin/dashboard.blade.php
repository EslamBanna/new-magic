    ...
    <div class="row mt-3">
        <div class="col-12 col-lg-6 col-xl-3 ">
          <div class="card gradient-deepblue pull-up">
            <div class="card-body">
               <h5 class="text-white mb-0">{{count($counter[3])}} <span class="float-right"><i class="fa fa-shopping-cart"></i></span></h5>
                 <div class="progress my-3" style="height:3px;">
                    <div class="progress-bar" style="width:55%"></div>
                 </div>
              <p class="mb-0 text-white small-font">Package Participation 
             </div>
          </div> 
        </div>
      <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-orange pull-up">
          <div class="card-body">
             ...
             <p class="mb-0 text-white small-font">Total consultations 
           </div>
        </div>
      </div>
      <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-ohhappiness pull-up">
           <div class="card-body">
             <h5 class="text-white mb-0">{{count($counter[0])}}<span class="float-right"><i class="far fa-user"></i></span></h5>
               <div class="progress my-3" style="height:3px;">
                  <div class="progress-bar" style="width:55%"></div>
               </div>
      ...
      {{-- <div class="col-12 col-lg-6 col-xl-3">
        <div class="card gradient-ibiza pull-up">
           <div class="card-body">
             <h5 class="text-white mb-0">{{count($counter[1])}} <span class="float-right"><i class="fas fa-feather-alt"></i></span></h5>
               <div class="progress my-3" style="height:3px;">
                  <div class="progress-bar" style="width:55%"></div>
               </div>
             <p class="mb-0 text-white small-font">Total Messages 
           </div>
        </div>
      </div> --}}
    </div>
