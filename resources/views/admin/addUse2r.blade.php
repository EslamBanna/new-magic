            ...
            <div class="row">
                <div class="col-md-8 ">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" name="name" placeholder="user Name" value="{{old('fullname')}}" required="">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" id="validationCustom03" name="password" placeholder="user password" value="{{old('password')}}" required="" minlength="8">
