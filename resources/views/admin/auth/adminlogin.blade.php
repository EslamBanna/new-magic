              ...
              <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
                <div class="hero-wrap rounded shadow-lg p-4 py-sm-5 px-sm-5 my-4">
                  ...
                  <div class="hero-content">
                    ...
                    <form id="loginForm" action="{{route('admin.login')}}" class="form-dark" method="post">
                        @csrf
                      <div class="form-group icon-group">
                        <input type="email" class="form-control" name="email"  id="emailAddress" required placeholder="Email Address">
                      ...
                      <div class="row text-2 mt-4">
                        <div class="col-sm">
                          <div class="form-check custom-control custom-checkbox">
                            <input id="remember-me" name="remember_me" class="custom-control-input" type="checkbox">
